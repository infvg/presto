 ...
 */
package com.facebook.presto.plugin.sybase;
        ...
        extends BaseJdbcClient
{
    ...
    @Inject
    public SybaseClient(JdbcConnectorId connectorId, BaseJdbcConfig config)
    {
        super(connectorId, config, "\"", new DriverConnectionFactory(new SybDriver(), config));
    ...
    {
        try (Connection connection = connectionFactory.openConnection(identity)) {
            if (!oldTable.getSchemaName().equals(newTable.getSchemaName())) {
